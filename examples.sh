...
./target/debug/brrrr fa2jsonl /tmp/fasta.fasta | jq
...
./target/debug/brrrr gff2jsonl --gff-type gff2 /tmp/gff.gtf | jq
...
echo
./target/debug/brrrr fq2jsonl /tmp/example.fastq | jq
